...
sample_ipns = [
    ...
    "first_name=Timothy&mc_fee=0.54&address_country_code=GB&address_name=Test+User&notify_version=3.9&custom=&"
    ...
    "option_selection2_1=-&last_name=Hague&address_state=&option_selection2_2=-&item_name1=Philosophy+of+World&"
    ...
    "payment_date=15%3A27%3A52+Jan+01%2C+2018+PST&payment_status=Completed&payment_method=credit_card&"
